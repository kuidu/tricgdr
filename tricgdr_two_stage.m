...
% [x, y] = tricgdr(A, b, c, M, N, k, p, tol, maxcycle, mreorth)
% [x, y] = tricgdr(A, b, c, M, N, k, p, tol, maxcycle, mreorth, exres)
%
%
...
%
% tol, maxcycle    tolerance and number of maximum iterations
%
%
% Name, Value   name-Value pairs determine other options. Name should be in
%               {'mreorth', 'exres'}. 'mreorth' means number of
%               basis vectors reorthogonalized, 'exres' means whether compute
%               exact residual norms or not. Corresponding values are {0, false}.
%
%
% Returns
% --------------
...
[varargout{1:5}] = deal(U(:, 1:k), T(1:k, 1:k), V(:, 1:k), MU(:, 1:k), NV(:, 1:k));
